...
[2]: /reference/folder--full#param-shared_link-permissions
[3]: /reference/file--full#param-shared_link-permissions
[4]: /reference/file--full/#param-shared_link_permission_options
[5]: /reference/web-link/#param-shared_link-permissions

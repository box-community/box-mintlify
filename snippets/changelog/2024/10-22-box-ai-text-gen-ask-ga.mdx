<Update label="Box AI API — Document Q&A and Box AI API — Text Generation generally available" description="2024-10-22" tags={["New features", "Impactful changes", "API"]}>

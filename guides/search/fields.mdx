...
[File](/reference/resources/file), [Folder](/reference/resources/folder), or [Web Link](/reference/resources/web_link). Each of
...
and [full Web Link](/reference/resources/web_link) resources.

...
Exploring the top level of a Box [user object](/reference/resources/user) we can see
...
* Email association is only viable for [managed users](/platform/user-types/#managed-users). [App users](/platform/user-types/#app-user) are automatically assigned an email address by Box, meaning that you cannot assign the `login` to be the email from the SSO service.
...
* Only the [managed users](/platform/user-types/#managed-users) type is being used, not [app users](/platform/user-types/#app-user).

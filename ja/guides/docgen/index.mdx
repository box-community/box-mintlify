...
<RelatedLinks
  ...
  items={[
    { label: "Box Doc Genの使い方", href: "/ja/guides/docgen/docgen-getting-started", badge: "GUIDE" },
    { label: "Box Doc Genテンプレート", href: "/ja/guides/docgen/docgen-templates", badge: "GUIDE" },
    { label: "Box Doc Genジョブ", href: "/ja/guides/docgen/docgen-jobs", badge: "GUIDE" },
    { label: "ファイルをBox Doc Genテンプレートとして設定", href: "/ja/guides/docgen/mark-template", badge: "GUIDE" },
    { label: "ドキュメントの生成", href: "/ja/guides/docgen/generate-document", badge: "GUIDE" }
  ]}
/>

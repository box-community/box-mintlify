...
<RelatedLinks
  ...
  items={[
    { label: "Box AIの使い方", href: "/ja/guides/box-ai/ai-tutorials/prerequisites", badge: "GUIDE" },
    ...
    { label: "AIモデルの構成の上書き", href: "/ja/guides/box-ai/ai-agents/ai-agent-overrides", badge: "GUIDE" }
  ]}
/>

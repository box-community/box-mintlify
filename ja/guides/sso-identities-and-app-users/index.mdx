...
<RelatedLinks
  ...
  items={[
    ...
    { label: "ユーザーのプロビジョニング", href: "/ja/guides/users/provision/index", badge: "GUIDE" },
    { label: "App Userの作成", href: "/ja/guides/users/create-app-user", badge: "GUIDE" },
    { label: "管理対象ユーザーの作成", href: "/ja/guides/users/create-managed-user", badge: "GUIDE" }
  ]}
/>

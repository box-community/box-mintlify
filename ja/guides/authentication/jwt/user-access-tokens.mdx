...
<RelatedLinks
  ...
  items={[
    { label: "SDKを使用したOAuth 2.0", href: "/ja/guides/authentication/oauth2/with-sdk", badge: "GUIDE" },
    { label: "SDKを使用しないOAuth 2.0", href: "/ja/guides/authentication/oauth2/without-sdk", badge: "GUIDE" }
  ]}
/>

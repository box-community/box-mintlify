...
<RelatedLinks
  ...
  items={[
    { label: "Webhookイベントトリガー", href: "/ja/guides/webhooks/triggers", badge: "GUIDE" },
    { label: "V2 Webhook", href: "/ja/guides/webhooks/v2/index", badge: "GUIDE" },
    { label: "Webhookの削除", href: "/ja/guides/webhooks/v2/delete-v2", badge: "GUIDE" }
  ]}
/>

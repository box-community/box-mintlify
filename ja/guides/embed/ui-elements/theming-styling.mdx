...
<RelatedLinks
  ...
  items={[
    { label: "UI Element", href: "/ja/guides/embed/ui-elements/index", badge: "GUIDE" },
    { label: "コンテンツエクスプローラ", href: "/ja/guides/embed/ui-elements/explorer", badge: "GUIDE" },
    { label: "コンテンツアップローダー", href: "/ja/guides/embed/ui-elements/uploader", badge: "GUIDE" }
  ]}
/>

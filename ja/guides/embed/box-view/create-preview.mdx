...
<RelatedLinks
  ...
  items={[
    { label: "設定", href: "/ja/guides/embed/box-view/setup", badge: "GUIDE" },
    { label: "ファイルのアップロード", href: "/ja/guides/embed/box-view/upload-file", badge: "GUIDE" },
    { label: "インストール", href: "/ja/guides/embed/ui-elements/installation", badge: "GUIDE" },
    { label: "コンテンツプレビュー", href: "/ja/guides/embed/ui-elements/preview", badge: "GUIDE" }
  ]}
/>
...
<RelatedLinks
  ...
  items={[
    { label: "ファイルのプレビューの作成", href: "/ja/guides/embed/box-view/create-preview", badge: "GUIDE" }
  ]}
/>

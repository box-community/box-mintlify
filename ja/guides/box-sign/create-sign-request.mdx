...
<RelatedLinks
  ...
  items={[
    { label: "Box Signのリクエストの再送信", href: "/ja/guides/box-sign/resend-sign-request", badge: "GUIDE" },
    { label: "Box Signのリクエストのキャンセル", href: "/ja/guides/box-sign/cancel-sign-request", badge: "GUIDE" },
    { label: "Signテンプレートを使用した署名リクエストの作成", href: "/ja/guides/box-sign/sign-templates", badge: "GUIDE" }
  ]}
/>

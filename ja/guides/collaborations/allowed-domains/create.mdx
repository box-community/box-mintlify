...
<RelatedLinks
  ...
  items={[
    { label: "コラボレーション", href: "/ja/guides/collaborations/index", badge: "GUIDE" },
    { label: "コラボレーションが許可されているドメインのリストの取得", href: "/ja/guides/collaborations/allowed-domains/list", badge: "GUIDE" },
    { label: "以前コラボレーションが許可されたドメインの削除", href: "/ja/guides/collaborations/allowed-domains/delete", badge: "GUIDE" }
  ]}
/>

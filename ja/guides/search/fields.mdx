...
---
デフォルトでは、検索APIによって**標準**形式の[ファイル](/reference/resources/file)、[フォルダ](/reference/resources/folder)、または[ウェブリンク](/reference/resources/web_link)が返されます。これらの各リソースでは、`fields`クエリパラメータを使用してリクエストできる追加のフィールドがサポートされています。
...
これらのフィールドの詳細については、[ファイル (詳細)](/reference/resources/file--full)、[フォルダ (詳細)](/reference/resources/folder--full)、および[ウェブリンク (詳細)](/reference/resources/web_link) のリソースを確認してください。

...
<RelatedLinks
  ...
  items={[
    { label: "OAuth 2.0を使用した設定", href: "/ja/guides/authentication/oauth2/oauth2-setup", badge: "GUIDE" }
  ]}
/>
## スクリプト構造
...
<RelatedLinks
  ...
  items={[
    { label: "OAuth 2.0認証", href: "/ja/guides/authentication/oauth2/index", badge: "GUIDE" },
    { label: "ユーザーとフォルダのプロビジョニング", href: "/ja/guides/cli/scripts/provision-users-folders", badge: "GUIDE" },
    { label: "ユーザーのプロビジョニング解除とフォルダのアーカイブ", href: "/ja/guides/cli/scripts/deprovision-users", badge: "GUIDE" },
    { label: "ユーザーのゾーンの更新", href: "/ja/guides/cli/scripts/user-zones-mass-update", badge: "GUIDE" },
    { label: "非アクティブなユーザーのレポート", href: "/ja/guides/cli/scripts/report-inactive-users", badge: "GUIDE" }
  ]}
/>

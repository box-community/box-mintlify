...
<RelatedLinks
  ...
  items={[
    { label: "Enterprise Eventの取得", href: "/ja/guides/events/enterprise-events/for-enterprise", badge: "GUIDE" },
    { label: "User Eventの取得", href: "/ja/guides/events/user-events/for-user", badge: "GUIDE" },
    { label: "Long pollingイベント", href: "/ja/guides/events/user-events/polling", badge: "GUIDE" },
    { label: "ストリーム位置のページネーション", href: "/ja/guides/events/parameters/pagination", badge: "GUIDE" }
  ]}
/>

...
<RelatedLinks
  ...
  items={[
    { label: "承認", href: "/ja/guides/authorization/index", badge: "GUIDE" },
    { label: "OAuth 2.0を使用した設定", href: "/ja/guides/authentication/oauth2/oauth2-setup", badge: "GUIDE" },
    { label: "JWTを使用した設定", href: "/ja/guides/authentication/jwt/jwt-setup", badge: "GUIDE" }
  ]}
/>
...
<RelatedLinks
  ...
  items={[
    { label: "アクセス制限付きアプリの承認", href: "/ja/guides/authorization/limited-access-approval", badge: "GUIDE" },
    { label: "カスタムスキルの承認", href: "/ja/guides/authorization/custom-skill-approval", badge: "GUIDE" }
  ]}
/>

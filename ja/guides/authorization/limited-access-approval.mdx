...
<RelatedLinks
  ...
  items={[
    ...
    { label: "アプリトークン認証を使用した設定", href: "/ja/guides/authentication/app-token/app-token-setup", badge: "GUIDE" }
  ]}
/>
...
<RelatedLinks
  ...
  items={[
    { label: "Platformアプリの承認", href: "/ja/guides/authorization/platform-app-approval", badge: "GUIDE" },

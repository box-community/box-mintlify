...
<RelatedLinks
  ...
  items={[
    { label: "フォルダの作成", href: "/ja/guides/folders/single/create", badge: "GUIDE" },
    { label: "フォルダの更新", href: "/ja/guides/folders/single/update", badge: "GUIDE" },
    { label: "フォルダの削除", href: "/ja/guides/folders/single/delete", badge: "GUIDE" }
  ]}
/>

...
<RelatedLinks
  ...
  items={[
    { label: "メタデータカスケードポリシーのリストの取得", href: "/ja/guides/metadata/cascades/list", badge: "GUIDE" },
    { label: "フォルダ内のすべての項目に対するメタデータの強制適用", href: "/ja/guides/metadata/cascades/force-apply", badge: "GUIDE" },
    { label: "メタデータカスケードポリシーの削除", href: "/ja/guides/metadata/cascades/delete", badge: "GUIDE" }
  ]}
/>

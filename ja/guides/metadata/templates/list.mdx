...
<RelatedLinks
  ...
  items={[
    { label: "メタデータテンプレートの取得", href: "/ja/guides/metadata/templates/get", badge: "GUIDE" },
    { label: "メタデータテンプレートの作成", href: "/ja/guides/metadata/templates/create", badge: "GUIDE" },
    { label: "メタデータテンプレートの更新", href: "/ja/guides/metadata/templates/update", badge: "GUIDE" }
  ]}
/>

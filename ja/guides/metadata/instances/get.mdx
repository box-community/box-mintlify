...
<RelatedLinks
  ...
  items={[
    { label: "項目のすべてのメタデータのリストの取得", href: "/ja/guides/metadata/instances/list", badge: "GUIDE" },
    { label: "項目へのメタデータの適用", href: "/ja/guides/metadata/instances/create", badge: "GUIDE" },
    { label: "メタデータテンプレートのスコープ", href: "/ja/guides/metadata/scopes", badge: "GUIDE" },
    { label: "すべてのメタデータテンプレートのリストの取得", href: "/ja/guides/metadata/templates/list", badge: "GUIDE" }
  ]}
/>
<RelatedLinks
  title="RELATED RESOURCES"
  items={[
    { label: "メタデータ", href: "/ja/guides/metadata/index", badge: "GUIDE" }
  ]}
/>

...
<RelatedLinks
  ...
  items={[
    { label: "共有リンクの項目の検索", href: "/ja/guides/shared-links/find-for-item", badge: "GUIDE" }
  ]}
/>
...
<RelatedLinks
  ...
  items={[
    { label: "ファイルのダウンロード", href: "/ja/guides/downloads/file", badge: "GUIDE" },
    { label: "新しいファイルのアップロード", href: "/ja/guides/uploads/direct/file", badge: "GUIDE" },
    { label: "ZIPアーカイブのダウンロード", href: "/ja/guides/downloads/zip-archive", badge: "GUIDE" }
  ]}
/>

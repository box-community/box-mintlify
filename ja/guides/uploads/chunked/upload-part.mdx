...
<RelatedLinks
  ...
  items={[
    { label: "アップロードセッションの作成", href: "/ja/guides/uploads/chunked/create-session", badge: "GUIDE" }
  ]}
/>
...
<RelatedLinks
  ...
  items={[
    { label: "アップロードセッションのコミット", href: "/ja/guides/uploads/chunked/commit-session", badge: "GUIDE" }
  ]}
/>

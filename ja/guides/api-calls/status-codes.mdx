...
<RelatedLinks
  ...
  items={[
    { label: "エラー", href: "/ja/guides/api-calls/permissions-and-errors/common-errors", badge: "GUIDE" },
    { label: "レート制限", href: "/ja/guides/api-calls/permissions-and-errors/rate-limits", badge: "GUIDE" }
  ]}
/>

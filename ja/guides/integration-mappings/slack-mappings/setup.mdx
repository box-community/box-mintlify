...
<RelatedLinks
  ...
  items={[
    { label: "Slack統合マッピングの作成", href: "/ja/guides/integration-mappings/slack-mappings/create-mapping", badge: "GUIDE" },
    { label: "Slack統合マッピングのリスト取得", href: "/ja/guides/integration-mappings/slack-mappings/list-mappings", badge: "GUIDE" },
    { label: "Slack統合マッピングの更新", href: "/ja/guides/integration-mappings/slack-mappings/update-mapping", badge: "GUIDE" },
    { label: "Slack統合マッピングの削除", href: "/ja/guides/integration-mappings/slack-mappings/delete-mapping", badge: "GUIDE" }
  ]}
/>

...
<RelatedLinks
  ...
  items={[
    { label: "Teams統合マッピングのリスト取得", href: "/ja/guides/integration-mappings/teams-mappings/list-mappings", badge: "GUIDE" },
    { label: "Teams統合マッピングの作成", href: "/ja/guides/integration-mappings/teams-mappings/create-mappings", badge: "GUIDE" },
    { label: "Teams統合マッピングの更新", href: "/ja/guides/integration-mappings/teams-mappings/update-mappings", badge: "GUIDE" },
    { label: "Teams統合マッピングの削除", href: "/ja/guides/integration-mappings/teams-mappings/delete-mappings", badge: "GUIDE" }
  ]}
/>

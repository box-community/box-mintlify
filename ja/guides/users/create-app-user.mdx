...
<RelatedLinks
  ...
  items={[
    ...
    { label: "ユーザーのプロビジョニング解除", href: "/ja/guides/users/deprovision/index", badge: "GUIDE" },
    { label: "ファイルとフォルダの転送", href: "/ja/guides/users/deprovision/transfer-folders", badge: "GUIDE" }
  ]}
/>

...
<RelatedLinks
  ...
  items={[
    { label: "ファイルのすべてのタスクのリストの取得", href: "/ja/guides/tasks/for-file", badge: "GUIDE" },
    { label: "タスクに関する情報の取得", href: "/ja/guides/tasks/get", badge: "GUIDE" },
    { label: "既存のタスクの変更", href: "/ja/guides/tasks/update", badge: "GUIDE" }
  ]}
/>

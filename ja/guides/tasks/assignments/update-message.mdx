...
<RelatedLinks
  ...
  items={[
    { label: "ユーザーへのタスクの割り当て", href: "/ja/guides/tasks/assignments/assign", badge: "GUIDE" },
    { label: "タスク割り当ての解除", href: "/ja/guides/tasks/assignments/unassign", badge: "GUIDE" },
    { label: "タスク割り当て状態の変更", href: "/ja/guides/tasks/assignments/change-state", badge: "GUIDE" }
  ]}
/>
